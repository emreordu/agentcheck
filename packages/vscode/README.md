...
AgentCheck supports one workspace folder at a time in v0.1. It runs only on explicit commands: there are no startup scans, file watchers, cloud uploads, API calls, or telemetry. See the [project README](https://github.com/emreordu/agentcheck#readme) for checkpoint semantics and limitations.
