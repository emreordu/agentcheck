...
export const BUILT_IN_FINDING_ACTIONS: Readonly<Record<FindingId, string>> = {
  ...
  [FINDING_IDS.dependencyAdded]: "Review the dependency changes for compatibility, runtime impact, and intended package selection.",
  [FINDING_IDS.dependencyRemoved]: "Review the dependency changes for compatibility, runtime impact, and intended package selection.",
  [FINDING_IDS.dependencyUpdated]: "Review the dependency changes for compatibility, runtime impact, and intended package selection.",
